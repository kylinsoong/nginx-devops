...
.*Build*
----
docker build -t cloudadc/nginx-devops-demo:2.0.3 -f Dockerfile.alpine .
docker push cloudadc/nginx-devops-demo:2.0.3
----

[source, bash]
.*Run alpine*
----
docker run -it --rm --name nginx -p 8001-8020:8001-8020 -p 8443:8443 cloudadc/nginx-devops-demo:2.0.3
----
